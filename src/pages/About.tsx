    ...
    <footer className="mx-auto text-[8px] md:text-xs h-6">
      <div className="text-muted-foreground mt-4 text-center w-[100vw] group">
        <div className="space-x-1 px-6">
          ...
          <a
            href={
              "https://github.com/byrdocs/byrdocs-frontend/commit/" +
...
function A({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <a
      href={href}
      className="mx-1 text-blue-500 hover:text-blue-400"
      target="_blank"
    >
      {children}
    </a>
      ...
      <div className="md:w-[800px] w-full md:m-auto px-10 flex flex-col md:min-h-[calc(100vh-48px)] min-h-[calc(100vh-24px)]">
        <div className="w-full m-auto h-98">
          ...
          <div className="space-y-3 text-xl">
            <li>
              BYR Docs
              是一个资料分享平台，旨在使北邮学生更方便地获取与北邮课程有关的教育资源，包括电子书籍、考试题目和复习资料等。
            </li>
            <li>
              BYR Docs 是一个开源项目，你可以在{" "}
              <A href="https://github.com/byrdocs">GitHub</A>{" "}
              上找到我们的代码和数据。
            </li>
            <li>
              如果您想要贡献文件，请参阅
              <A href="https://github.com/byrdocs/byrdocs-archive/blob/master/CONTRIBUTING.md">
                贡献指南
              </A>
              。 有任何问题或建议，请发送邮件至
              <A href="mailto:contact@byrdocs.org">contact@byrdocs.org</A>、在
              <A href="https://github.com/orgs/byrdocs/discussions">
                GitHub Discussions
              </A>
              留言或者加入我们的
